//
//  ExcelCollectionViewFlowLayout.m
//  testDemo
//
//  Created by lignpeng on 2018/5/15.
//  Copyright © 2018年 genpeng. All rights reserved.
//

#import "ExcelCollectionViewFlowLayout.h"

@implementation ExcelCollectionViewFlowLayout
...
- (NSArray *) layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    return [self layoutAttributesForElementsInRect:rect superArray:attributes];
}

- (NSArray *) layoutAttributesForElementsInRect:(CGRect)rect superArray:(NSMutableArray *)superArray {
    ...
    for (UICollectionViewLayoutAttributes *attributes in superArray) {
        ...
        if ([attributes.representedElementKind isEqualToString:UICollectionElementKindSectionHeader])
        {
            ...
            CGFloat offset = self.collectionView.contentOffset.y + self.naviHeight;
